...
<body>
    ...
    <div class="acc-forms">
        <form action="includes/user-register.php" method="post">
            <h1 style="font-size: 2.5em; margin-bottom: 30px;">Register a new account</h1>
            <input type="text" name="name" placeholder="Username"><br>
            <input type="password" name="password" placeholder="Password"><br>
            <button>Register</button>
        </form>
        <form action="includes/user-login.php" method="post" style="margin-top: 2em;">
            <h1 style="font-size: 2.5em; margin-bottom: 30px;">Login</h1>
            <input type="text" name="name" placeholder="Username"><br>
            <input type="password" name="password" placeholder="Password"><br>
            <button>Login</button>
        </form>
